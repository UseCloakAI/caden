// Device bezel for the iOS kit, ported from the Claude Design ios-frame starter (dark mode only).
// Raw hex/px values are intentional here: this mimics Apple hardware, not Caden UI.
...
export function IOSDevice({ children, width = 402, height = 874 }: { children: ReactNode; width?: number; height?: number }) {
  return (
    <div
      style={{
        width,
